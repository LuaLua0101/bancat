            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div id="create-news" class="card updates">
                    ...
                    <div id="create-box" class="show create-box card-body">
                        <form action="{{route('adpostEditProduct', ['id' => $product->id])}}" method="POST"
                            id="create-new" class="form-create" enctype='multipart/form-data'>
                            {{ csrf_field() }}
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="form-avatar">@if($product->cover !=
                                                "")
                                                {{substr($product->cover,0,strpos($product->cover,'?'))}} @else Choose
                                                file
                                                @endif </label>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" multiple="" class="custom-file-input" id="form-list_img"
                                                name="list_img[]">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="form-price" name="price"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="form-status" name="status">
                                        ...
                                        <option value="0" @if($product->status == 0) selected="" @endif>Hết hàng
                                        </option>
                                    </select>
                                </div>
                            </div>
